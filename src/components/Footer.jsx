...
const Footer = () => {
    return (
        <div className="mt-24">
            <footer className="footer text-white p-10 bg-[#5643a4] opacity-85  h-full md:h-64 items-center">
                <div>
            ...
            <div className='text-center text-white bg-[#5643a4] opacity-85  pb-5'>
